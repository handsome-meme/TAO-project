...
{
    Register<bit<16>,bit<1>>(1,3) pkt_num;
    ...
    Register<bit<16>,bit<16>>(65536,0) hash1_1_n;
    RegisterAction<bit<16>,bit<16>,bit<16>>(hash1_1_n) pkt_num_1={
		void apply(inout bit<16> register_data, out bit<16> pkt_num_o){
            if(ig_md.hash_pkt1 == 1){
                register_data = register_data + 1;
            }
            else{
                register_data = 0;
