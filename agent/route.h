...
#define SHC_ENCAP_TYPE_VALID(proto) \
    ((proto) > SHC_ENCAP_INVALID && (proto) < SHC_ENCAP_MAX)
...
#define SHC_ROUTE_TYPE_VALID(rtype) \
...
struct fib_res {
    ...
    int lpm_em;//用来判断是lpm还是em
};

// typedef int 
// (*rt_prefix_entry_cb_t)(struct shc_rib_key *key,
//                 int64_t f_res_id,
//                 int is_mroute,
//                 int is_nottl,
//                 uint32_t mpath_cnt,
...
extern void shc_nhop_init();

extern void initLink(struct ListNode_t* self);
<<<<<<< HEAD
=======

>>>>>>> 607453cc82875635443f2dc20e9bc62ac0565e8c
extern int
...
// shc_route_type_trans(vrf_dp_t *vrf_dp,
//                 const struct shc_rib_key *pfx, 
//                 rib_type_t rib_type);
...
// extern int
// shc_route_prefix_walk(vrf_dp_t *vrf_dp,
//                         rt_prefix_entry_cb_t cb, void *arg1, void *arg2, void *arg3);

// int
// shc_route_nhop_walk(vrf_dp_t *vrf_dp, int64_t f_res_id, 
