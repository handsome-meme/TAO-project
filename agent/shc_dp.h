...
/* VRF spec.*/
#define SHC_NR_VRF              (4096)
#define SHC_NR_ROUTES_ALL       (800 * 1024)
#define SHC_NR_FIB_RES_ALL      (800 * 1024) 
#define SHC_NR_NHOP_ALL         (SHC_NR_FIB_RES_ALL)
#define SHC_NR_TUNNEL_ALL       (8 * 1024)

#define SHC_VRF_NAME_LEN        (64)

#define VRF_NAME_VALID(vrfname)              \
    ((!!vrfname) && ((vrfname)[0] != '\0')   \
    && ((vrfname)[0] != ' ') \
    && (strlen(vrfname) < SHC_VRF_NAME_LEN) \
...
typedef struct {
    ...
    shc_swf_evt_stat_t evt_stat;
    //shc_swf_evt_stat_t evt_base_stat;
...
typedef int 
(*pmd_thr_cb_t)(shc_pmd_ctx_t *pmd_thr_ctx, void *arg1, void *arg2);
